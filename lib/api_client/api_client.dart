...
Future<FootprintResult> fetchFootprintResult(String val) async {
  ...
  print(val);
  String url = 'http://192.168.0.45:5000/get_footprint?keyword='+val;
...
Future<List<WebResult>> fetchWebResult(String val) async {
  ...
  String url = 'http://192.168.0.45:5000/get_web_data?item='+val;
  Response response = await get(url);
...
Future<List<ShopResult>> fetchShopResult(String val) async {
  ...
  String url = 'http://192.168.0.45:5000/get_shop_data?item='+val;
  Response response = await get(url);
